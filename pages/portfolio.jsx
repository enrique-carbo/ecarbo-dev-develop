...
const Portfolio = () => {
  ...
  return (
    <Layout title="Portfolio | ECarbo">
      ...
      <div className="grid md:grid-cols-3 gap-4 mt-10 mb-20 mx-5">
        <Card
          title="Medicina Estilo de Vida Website"
          description="Medical website about Lifestyle Medicine made with React, Next and Tailwind.."
          link="https://medicina-estilo-vida.vercel.app/"
          pathToImage="/img/portafolio/mev.png"
        />
      ...
      <div className="grid md:grid-cols-3 gap-4 mt-10 mb-20 mx-5">
        ...
        <Card
          title="Medico General Website"
          description="Medical website made with a Vue.js framework called Quasar.dev."
          link="https://www.medicogeneral.com.ar/"
          pathToImage="/img/portafolio/medicogeneral.png"
        />

        <Card
          title="Health Blog Website"
          description="Health blog developed with ASTRO framework."
          link="https://blog-salud.netlify.app/"
          pathToImage="/img/portafolio/health-blog.png"
        />
      </div>
    </Layout>
  );
